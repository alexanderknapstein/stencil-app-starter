...
class DocumentTeaser {
    constructor() {
        this.subtitle = 'Subtitle, bitte einpflegen';
        this.tags = [];
    }
    componentWillLoad() {
        if (this.data) {
    ...
    render() {
        ...
        return [
            h("div", null,
                ...
                h("div", { class: "meta" },
                    h("span", { class: "date" }, this.date.toFormat('dd.MM.yyyy')),
                    h("div", { class: "tags" }, tags)),
                h("div", { class: "subtitle" }, this.subtitle),
                h("div", { class: "downloads" },
                    h("a", { class: "view", href: this.viewLink }, "Ansehen"),
                    h("a", { class: "view", href: this.downloadLink }, "Herunterladen")))
        ];
    }
    static get is() { return "document-teaser"; }
    ...
    render() {
        if (this.data && this.data.length) {
            ...
            const list = this.data.map((doc) => {
                return h("document-teaser", { data: doc, class: "teaser" });
            });
            return h("div", { class: "documents-list" }, list);
        }
    }
    static get is() { return "documents-list"; }
    static get properties() { return {
        "data": {
            "type": "Any",
            "attr": "data"
