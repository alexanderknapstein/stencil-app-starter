...
import { IconRegistryService } from '../icon/resources/icon-registry-service';
...
export class App {
  ...
  /**
   * He we decorate a property to include the IconRegistryService class from il-components to have access to the methods getIcon() & setIcon()
   */
  @Prop({connect: 'il-icon-registry'}) iconRegistryInjector: any;

  componentWillLoad() {
    this.iconRegistryInjector.create().then((injector: IconRegistryService) => {
